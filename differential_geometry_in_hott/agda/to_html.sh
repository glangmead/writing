...
do
  ...
  pandoc --lua-filter tikz.lua --from markdown+footnotes+latex_macros -M document-css=true -M mainfont=Baskerville --css Agda.css --toc --mathml --standalone --metadata title=$i html/$i.md -o html/$i.html
  open html/$i.html
done
