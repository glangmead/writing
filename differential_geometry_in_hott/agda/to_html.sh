...
do
  ...
  pandoc --lua-filter tikz.lua --from markdown+footnotes+latex_macros -M document-css=false --css Agda.css --toc --mathjax --standalone --citeproc html/$i.md -o html/$i.html
  open html/$i.html
done
