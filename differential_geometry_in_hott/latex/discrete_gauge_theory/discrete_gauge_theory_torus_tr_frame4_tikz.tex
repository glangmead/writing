...
\draw[behind,front,key,arrow] (fur) -- (odt);
...
\fill[vfacet] (odt) -- (odl) -- (ful) -- cycle {};
\fill[rfacet] (odt) -- (bul) -- (odl) -- cycle {};
\fill[bfacet] (odt) -- (ful) -- (fur) -- cycle {};
\fill[gfacet] (odt) -- (fur) -- (odr) -- cycle {};
\fill[ofacet] (odt) -- (bul) -- (bur) -- cycle {};
\fill[yfacet] (odt) -- (odr) -- (bur) -- cycle {};
