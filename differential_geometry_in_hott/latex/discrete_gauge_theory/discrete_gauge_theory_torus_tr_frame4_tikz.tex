...
\fill[rfacet] (odt) -- (odl) -- (ful) -- cycle {};
\fill[ofacet] (odt) -- (bul) -- (odl) -- cycle {};
\fill[vfacet] (odt) -- (ful) -- (fur) -- cycle {};
\fill[bfacet] (odt) -- (fur) -- (odr) -- cycle {};
\fill[yfacet] (odt) -- (bul) -- (bur) -- cycle {};
\fill[gfacet] (odt) -- (odr) -- (bur) -- cycle {};
