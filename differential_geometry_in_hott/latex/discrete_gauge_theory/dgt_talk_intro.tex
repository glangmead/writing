...
Let \( M \) be a smooth 2-manifold without boundary, \( F_A \) the curvature of a connection \( A \) on the tangent bundle, and \( X \) a vector field with isolated zeroes \( x_1,\ldots,x_n \).
...
\[\begin{tikzcd}[ampersand replacement=\&,column sep=tiny]
  ...
  {\displaystyle{\Omega\left(\sum_{\mathrm{faces}\ f}\flat_f\right)}} \& {\displaystyle{\sum_{\mathrm{faces}\ f}I^X_f}}
...
\[
\input{figs/index_examples_tikz.tex}
\]
\endgroup
