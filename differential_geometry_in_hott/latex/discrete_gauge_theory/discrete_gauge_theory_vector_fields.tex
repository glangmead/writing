...
Each fiber \( T_i \) is pointed by \( X_i \), so we can define the map \( T_i\xrightarrow[]{-X_i}\Gg(m) \), and then give a name to the special term \( \rho_{ij}\defeq T_{ij}X_j - X_i \). It fits into a diagram
\begin{equation}
