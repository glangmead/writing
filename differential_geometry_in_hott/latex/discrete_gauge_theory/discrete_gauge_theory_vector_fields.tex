...
We\chcomment[id=Greg]{All new section} will again use the dimension structure of a marked presented manifold(\ref{def:marked_presented_manifold}) to construct vector fields on each skeleton. Let \( M:\simcomp \) be a combinatorial manifold and \( \mm\defeq \mrlzn(M) \) the corresponding marked presented manifold.
