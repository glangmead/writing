...
The goal of this paper is to try to indicate just how much of
...
\section{Appendix: the tangent bundle of the
...
\hfill
\begin{minipage}[t]{0.45\linewidth}
\includegraphics{./6b0a1aa167687f6f5182cc788cf399c6b7a4ce20.png}
\end{minipage}
...
\hfill
\begin{minipage}[t]{0.225\linewidth}
\includegraphics{./505704a8e51ba44a48f2805306c8aba6a9675aa2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.225\linewidth}
\includegraphics{./b7357b79cf34c1f4a8961ddb746680a3074056fe.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.225\linewidth}
\includegraphics{./aff62935109bbb6d85b8d229d1a56a5770b06509.png}
\end{minipage}
