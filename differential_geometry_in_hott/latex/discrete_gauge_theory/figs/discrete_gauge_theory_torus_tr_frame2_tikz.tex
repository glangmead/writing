...
\fill[vfacet] (fbl) -- (odl) -- (ful) -- cycle {};
\fill[bfacet] (ful) -- (idl) -- (fbl) -- cycle {};
\fill[rfacet] (ful) -- (odt) -- (odl) -- cycle {};
\fill[gfacet] (idt) -- (idl) -- (ful) -- cycle {};

\fill[yfacet] (fur) -- (idt) -- (ful) -- cycle {};
\fill[ofacet] (fur) -- (odt) -- (ful) -- cycle {};
