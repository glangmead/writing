...
\draw[ahead,front,arrow] (odt) -- (ful);
...
\fill[rfacet] (fbl) -- (odl) -- (ful) -- cycle {};
\fill[vfacet] (ful) -- (idl) -- (fbl) -- cycle {};
\fill[ofacet] (ful) -- (odt) -- (odl) -- cycle {};
\fill[bfacet] (idt) -- (idl) -- (ful) -- cycle {};

\fill[gfacet] (fur) -- (idt) -- (ful) -- cycle {};
\fill[yfacet] (fur) -- (odt) -- (ful) -- cycle {};
